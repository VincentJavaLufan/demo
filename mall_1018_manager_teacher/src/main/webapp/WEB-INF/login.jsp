	...
	<div class="middle">
		<div class="login">
			...
			<form action="login.do" id="login_form" method="post">
				<div class="input1" style="height:40px">
					<input type="text" class="input1_01" name="yh_mch" style="height:30px; width:300px;"/>
				</div>
				<div class="blank_01"></div>
				<div class="blank_01"></div>
				<div class="input2" style="height:40px">
					<input type="text" class="input1_01" name="yh_mm" style="height:30px; width:300px;"/>
				</div>
			...
			<div class="blank_01"></div>
			<a href="login.do" class="aline">
				<div class="red_button" onclick="to_submit()" style="color:red" type="button">
					登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录
				</div>
			</a>
			<div class="blank_01"></div>
