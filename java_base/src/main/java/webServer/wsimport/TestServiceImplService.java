 ...
 * 
 */
@WebServiceClient(name = "TestServiceImplService", targetNamespace = "http://webServer/", wsdlLocation = "http://192.168.0.109:1234/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICEIMPLSERVICE_QNAME = new QName("http://webServer/", "TestServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.109:1234/ws?wsdl");
    ...
    public TestServiceImpl getTestServiceImplPort() {
        return super.getPort(new QName("http://webServer/", "TestServiceImplPort"), TestServiceImpl.class);
    }
    ...
    public TestServiceImpl getTestServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webServer/", "TestServiceImplPort"), TestServiceImpl.class, features);
    }
